                    ...
                    <div class="row mg-b-20">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control multiple" multiple name="role_user[]" id="rolesSelect">
...
@section('js')
    ...
    <script>
        // Assuming you have the old roles as an array in JavaScript
        var oldRoles = {!! json_encode($oldRoles) !!};

        var rolesSelect = document.getElementById('rolesSelect');
        var options = rolesSelect.options;

        for (var i = 0; i < options.length; i++) {
            if (oldRoles.includes(options[i].value)) {
