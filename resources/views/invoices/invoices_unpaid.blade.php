...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفواتير الغيرالمدفوعة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة الفواتير</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap">
                            ...
                            @foreach($invoices as $invoice)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('invoiceDetails',$invoice->id)}}">{{$invoice->section->section_name}}</a>
                                    </td>
