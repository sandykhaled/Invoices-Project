                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">{{\App\models\Invoice::where('Status','غير مدفوعة')->count()}}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{number_format(\App\models\Invoice::where('Value_status','مدفوعة')->sum('Total'),2)}}
                                </h4>
